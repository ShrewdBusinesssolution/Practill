...
class DateTimeHelper {
    ...
    */
    ...
    /**
    * currentMonth Start Date
    * @returns timestamp
    */
    static currentMonthStartDate = () => {
        return moment().tz("Asia/Kolkata").startOf('month').format("DD-MM-YYYY");
    };
    
    /**
    * currentMonth End Date
    * @returns timestamp
    */
    static currentMonthEndDate = () => {
        return moment().tz("Asia/Kolkata").endOf('month').format("DD-MM-YYYY");
    };
